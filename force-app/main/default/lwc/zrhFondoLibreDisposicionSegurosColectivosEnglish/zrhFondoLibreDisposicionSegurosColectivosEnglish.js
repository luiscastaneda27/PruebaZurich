...
import { OMNIDEF } from './zrhFondoLibreDisposicionSegurosColectivosEnglish_def.js';
import tmpl from './zrhFondoLibreDisposicionSegurosColectivosEnglish.html';
import tmpl_nds from './zrhFondoLibreDisposicionSegurosColectivosEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhFondoLibreDisposicionSegurosColectivosEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
