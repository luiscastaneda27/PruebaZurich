...
import { OMNIDEF } from './zrhGestionarConveniosSegurosColectivosSpanish_def.js';
import tmpl from './zrhGestionarConveniosSegurosColectivosSpanish.html';
import tmpl_nds from './zrhGestionarConveniosSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhGestionarConveniosSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
