...
import { OMNIDEF } from './zrhFondoLibreDisposicionSegurosColectivosSpanish_def.js';
import tmpl from './zrhFondoLibreDisposicionSegurosColectivosSpanish.html';
import tmpl_nds from './zrhFondoLibreDisposicionSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhFondoLibreDisposicionSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
