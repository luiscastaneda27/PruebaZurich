...
import { OMNIDEF } from './zrhCrearPDFPolizaSegurosColectivosSpanish_def.js';
import tmpl from './zrhCrearPDFPolizaSegurosColectivosSpanish.html';
import tmpl_nds from './zrhCrearPDFPolizaSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhCrearPDFPolizaSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
