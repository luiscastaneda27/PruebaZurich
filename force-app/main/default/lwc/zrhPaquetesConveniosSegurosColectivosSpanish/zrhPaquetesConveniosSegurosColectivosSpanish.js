...
import { OMNIDEF } from './zrhPaquetesConveniosSegurosColectivosSpanish_def.js';
import tmpl from './zrhPaquetesConveniosSegurosColectivosSpanish.html';
import tmpl_nds from './zrhPaquetesConveniosSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhPaquetesConveniosSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
