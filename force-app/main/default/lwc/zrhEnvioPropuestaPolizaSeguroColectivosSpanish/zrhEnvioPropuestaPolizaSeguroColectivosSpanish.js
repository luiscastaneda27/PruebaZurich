...
import { OMNIDEF } from './zrhEnvioPropuestaPolizaSeguroColectivosSpanish_def.js';
import tmpl from './zrhEnvioPropuestaPolizaSeguroColectivosSpanish.html';
import tmpl_nds from './zrhEnvioPropuestaPolizaSeguroColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhEnvioPropuestaPolizaSeguroColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
