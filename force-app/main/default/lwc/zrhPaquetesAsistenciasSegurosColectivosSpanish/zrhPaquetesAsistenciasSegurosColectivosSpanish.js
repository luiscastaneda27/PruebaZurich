...
import { OMNIDEF } from './zrhPaquetesAsistenciasSegurosColectivosSpanish_def.js';
import tmpl from './zrhPaquetesAsistenciasSegurosColectivosSpanish.html';
import tmpl_nds from './zrhPaquetesAsistenciasSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhPaquetesAsistenciasSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
