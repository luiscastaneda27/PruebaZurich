...
import { OMNIDEF } from './zrhVisualizarTarifaPlanSegurosColectivosSpanish_def.js';
import tmpl from './zrhVisualizarTarifaPlanSegurosColectivosSpanish.html';
import tmpl_nds from './zrhVisualizarTarifaPlanSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhVisualizarTarifaPlanSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
