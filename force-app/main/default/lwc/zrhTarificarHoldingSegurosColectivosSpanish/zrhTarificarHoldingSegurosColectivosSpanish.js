...
import { OMNIDEF } from './zrhTarificarHoldingSegurosColectivosSpanish_def.js';
import tmpl from './zrhTarificarHoldingSegurosColectivosSpanish.html';
import tmpl_nds from './zrhTarificarHoldingSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhTarificarHoldingSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
