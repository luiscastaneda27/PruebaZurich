...
import { OMNIDEF } from './zrhCrearReservasYCotizacionesSegurosColectivosSpanish_def.js';
import tmpl from './zrhCrearReservasYCotizacionesSegurosColectivosSpanish.html';
import tmpl_nds from './zrhCrearReservasYCotizacionesSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhCrearReservasYCotizacionesSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
