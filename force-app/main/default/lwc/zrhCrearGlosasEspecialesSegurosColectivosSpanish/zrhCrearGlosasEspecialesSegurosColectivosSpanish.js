...
import { OMNIDEF } from './zrhCrearGlosasEspecialesSegurosColectivosSpanish_def.js';
import tmpl from './zrhCrearGlosasEspecialesSegurosColectivosSpanish.html';
import tmpl_nds from './zrhCrearGlosasEspecialesSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhCrearGlosasEspecialesSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
