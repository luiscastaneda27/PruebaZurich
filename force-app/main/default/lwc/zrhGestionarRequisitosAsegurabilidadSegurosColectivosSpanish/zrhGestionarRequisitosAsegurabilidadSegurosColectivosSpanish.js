...
import { OMNIDEF } from './zrhGestionarRequisitosAsegurabilidadSegurosColectivosSpanish_def.js';
import tmpl from './zrhGestionarRequisitosAsegurabilidadSegurosColectivosSpanish.html';
import tmpl_nds from './zrhGestionarRequisitosAsegurabilidadSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhGestionarRequisitosAsegurabilidadSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
