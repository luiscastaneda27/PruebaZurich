...
import { OMNIDEF } from './zrhGestionarSobrePrimaSegurosColectivosSpanish_def.js';
import tmpl from './zrhGestionarSobrePrimaSegurosColectivosSpanish.html';
import tmpl_nds from './zrhGestionarSobrePrimaSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhGestionarSobrePrimaSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
