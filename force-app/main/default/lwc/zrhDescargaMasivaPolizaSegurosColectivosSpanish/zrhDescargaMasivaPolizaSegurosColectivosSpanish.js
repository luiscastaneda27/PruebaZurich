...
import { OMNIDEF } from './zrhDescargaMasivaPolizaSegurosColectivosSpanish_def.js';
import tmpl from './zrhDescargaMasivaPolizaSegurosColectivosSpanish.html';
import tmpl_nds from './zrhDescargaMasivaPolizaSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhDescargaMasivaPolizaSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
