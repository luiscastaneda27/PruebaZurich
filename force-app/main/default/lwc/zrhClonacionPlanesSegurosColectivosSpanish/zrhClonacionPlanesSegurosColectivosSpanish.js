...
import { OMNIDEF } from './zrhClonacionPlanesSegurosColectivosSpanish_def.js';
import tmpl from './zrhClonacionPlanesSegurosColectivosSpanish.html';
import tmpl_nds from './zrhClonacionPlanesSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhClonacionPlanesSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
