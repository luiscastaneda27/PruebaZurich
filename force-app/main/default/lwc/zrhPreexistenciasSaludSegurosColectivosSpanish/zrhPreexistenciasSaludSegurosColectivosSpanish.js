...
import { OMNIDEF } from './zrhPreexistenciasSaludSegurosColectivosSpanish_def.js';
import tmpl from './zrhPreexistenciasSaludSegurosColectivosSpanish.html';
import tmpl_nds from './zrhPreexistenciasSaludSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhPreexistenciasSaludSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
