...
import { OMNIDEF } from './zrhGestionarTopesSegurosColectivosSpanish_def.js';
import tmpl from './zrhGestionarTopesSegurosColectivosSpanish.html';
import tmpl_nds from './zrhGestionarTopesSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhGestionarTopesSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
