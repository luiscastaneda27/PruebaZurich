...
import { OMNIDEF } from './zrhModificarGlosasEspecialesSegurosColectivosSpanish_def.js';
import tmpl from './zrhModificarGlosasEspecialesSegurosColectivosSpanish.html';
import tmpl_nds from './zrhModificarGlosasEspecialesSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhModificarGlosasEspecialesSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
