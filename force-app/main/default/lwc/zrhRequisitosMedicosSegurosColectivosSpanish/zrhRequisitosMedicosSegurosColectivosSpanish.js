...
import { OMNIDEF } from './zrhRequisitosMedicosSegurosColectivosSpanish_def.js';
import tmpl from './zrhRequisitosMedicosSegurosColectivosSpanish.html';
import tmpl_nds from './zrhRequisitosMedicosSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhRequisitosMedicosSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
