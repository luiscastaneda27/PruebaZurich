...
import { OMNIDEF } from './zrhTarificacionPlanesSaludSegurosColectivosSpanish_def.js';
import tmpl from './zrhTarificacionPlanesSaludSegurosColectivosSpanish.html';
import tmpl_nds from './zrhTarificacionPlanesSaludSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhTarificacionPlanesSaludSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
