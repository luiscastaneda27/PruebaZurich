...
import { OMNIDEF } from './zrhGestionarBMISegurosColectivosSpanish_def.js';
import tmpl from './zrhGestionarBMISegurosColectivosSpanish.html';
import tmpl_nds from './zrhGestionarBMISegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhGestionarBMISegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
