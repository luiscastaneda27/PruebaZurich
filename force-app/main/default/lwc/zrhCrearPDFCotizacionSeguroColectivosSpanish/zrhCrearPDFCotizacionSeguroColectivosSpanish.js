...
import { OMNIDEF } from './zrhCrearPDFCotizacionSeguroColectivosSpanish_def.js';
import tmpl from './zrhCrearPDFCotizacionSeguroColectivosSpanish.html';
import tmpl_nds from './zrhCrearPDFCotizacionSeguroColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhCrearPDFCotizacionSeguroColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
