...
import { OMNIDEF } from './zrhTarificacionPlanesSegurosColectivosSpanish_def.js';
import tmpl from './zrhTarificacionPlanesSegurosColectivosSpanish.html';
import tmpl_nds from './zrhTarificacionPlanesSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhTarificacionPlanesSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
