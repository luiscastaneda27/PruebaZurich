...
import { OMNIDEF } from './zrhPaquetesConveniosLineaSegurosColectivosSpanish_def.js';
import tmpl from './zrhPaquetesConveniosLineaSegurosColectivosSpanish.html';
import tmpl_nds from './zrhPaquetesConveniosLineaSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhPaquetesConveniosLineaSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
