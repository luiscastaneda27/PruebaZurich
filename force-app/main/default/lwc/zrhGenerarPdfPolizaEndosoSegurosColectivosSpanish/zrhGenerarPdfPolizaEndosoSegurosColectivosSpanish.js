...
import { OMNIDEF } from './zrhGenerarPdfPolizaEndosoSegurosColectivosSpanish_def.js';
import tmpl from './zrhGenerarPdfPolizaEndosoSegurosColectivosSpanish.html';
import tmpl_nds from './zrhGenerarPdfPolizaEndosoSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhGenerarPdfPolizaEndosoSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
