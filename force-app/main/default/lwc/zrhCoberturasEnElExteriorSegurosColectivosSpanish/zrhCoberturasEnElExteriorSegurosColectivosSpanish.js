...
import { OMNIDEF } from './zrhCoberturasEnElExteriorSegurosColectivosSpanish_def.js';
import tmpl from './zrhCoberturasEnElExteriorSegurosColectivosSpanish.html';
import tmpl_nds from './zrhCoberturasEnElExteriorSegurosColectivosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class zrhCoberturasEnElExteriorSegurosColectivosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
